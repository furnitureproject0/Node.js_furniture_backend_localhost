...
import { getOrders, adminCreateOrderForClient, adminUpdateOrderForClient, cancelOrderByAdmin, getOrderDetails, downloadOrderPDF, getFilteredOrderServices } from '../controllers/order-controller.js';
...
router.get('/filtered-services', authorize('super_admin', 'site_admin', 'company_admin', 'company_secretary'), getFilteredOrderServices);
